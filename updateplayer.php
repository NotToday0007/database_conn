...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="admin_page.php">Home Page</a>
    </div>
     <div class="collapse navbar-collapse" id="nav">
    <ul class="nav navbar-nav">
      <li><a href="homeplayer.php">Player Data </a></li>
      <!-- <li><a href="http://localhost/management/studentform.php">Enter Student Data </a></li> -->
      <li><a href="player.php">Add Player Data </a></li>
      <!-- <li><a href="updatestudentdata.php">Update Student Data </a></li> -->
      <li><a href="updateplayer.php">Find || Update // Delete Player Data </a></li>
...
<form method ="post"   action="">
	<h1>ID Number (Use to Search Player data)</h1>
  <input type="number" name="id"  class="form-control" placeholder="ID No. /Automatic Number Genrates" value="<?php echo($id);?>">
		<h1>Player Name</h1>
	<input type="text" name="name" class="form-control" placeholder="Enter Player Name" value="<?php echo($name);?>" >
<h1>Email</h1>
	<input type="email" name="email" class="form-control" placeholder="Enter Email" value="<?php echo($email);?>" >
  <div class="form-group row">
  <div class="col-xs-6">
	<h1>Phone (10-digit)</h1>
	<input type="tel" pattern="^\d{11}$" class="form-control" name="phone"  placeholder="11 digit Phone number" value="<?php echo($phone);?>">
</div>
  <div class="col-xs-6">
		<h1>Select State</h1>
...
<input type="text" name="gender" class="form-control" placeholder="gender" value="<?php echo($gender);?>" >
    ...
    <div class="col-lg-8">
			<h2>Player Data Update | Delete</h2>
<?php
$servername = "localhost";
$username = "root";
$password = "";
